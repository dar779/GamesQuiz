...
@Component({
  selector: 'app-juegodesarrollador',
  templateUrl: './juegodesarrollador.component.html',
  styleUrl: './juegodesarrollador.component.scss'
})

export class JuegodesarrolladorComponent {
